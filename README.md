...
This is a [Cockpit](https://cockpit-project.org/) module for editing and running 
ansible scripts. It uses
...
```
git clone https://github.com/openSUSE/cockpit-ansible.git
cd cockpit-ansible
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/cockpit-ansible
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/cockpit-ansible

# Running eslint

Cockpit Ansible uses [ESLint](https://eslint.org/) to automatically check
